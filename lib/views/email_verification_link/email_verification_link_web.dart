...
class EmailVerificationLinkScreenWeb extends StatefulWidget {
  const EmailVerificationLinkScreenWeb({super.key});

  @override
  State<EmailVerificationLinkScreenWeb> createState() => _EmailVerificationLinkScreenTablet();
}

class _EmailVerificationLinkScreenTablet extends State<EmailVerificationLinkScreenWeb> {
