...
import '../../widgets/flim_card_vertical.dart';class DetailedMovieScreenTablet extends StatefulWidget {
  final String filmID;
  const DetailedMovieScreenTablet({super.key, required this.filmID});
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        'Mô tả: $title',
                        style: contentStyle.copyWith(fontSize: 25, fontWeight: FontWeight.bold, overflow: TextOverflow.visible)
                      ),
                    ),
                    IconButton(
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        'Diễn viên: $title',
                        style: contentStyle.copyWith(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.white),
                      ),
                    ),
                    IconButton(
                      onPressed: () => Navigator.pop(context),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                                film!.name,
                                style: contentStyle.copyWith(fontSize: 20.sp, fontWeight: FontWeight.bold)
                            ),
                          ),
                          Row(
                            children: [
                                        ...
                                        return InkWell(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Text(
                                                  "Danh sách",
                                                  style: contentStyle.copyWith(fontSize: 12.sp, color: Colors.grey)
                                              )
                                            ],
                                          ),
                                        );
                                ...
                                return SliverList.separated(
                                  itemBuilder: (BuildContext context, int index) {
                                    ...
                                    return FilmCardVertical(
                                        ...
                                        age: sameFilm.age,
                                        ontap: (){
                                          NavigatorHelper.replaceWith(context, DetailedMovieScreenTablet(filmID: sameFilm.id));
                                        },
