...
class CommentScreenTablet extends StatefulWidget {
  const CommentScreenTablet({super.key, required this.filmID, required this.loadLikes, required this.loadDisLikes, required this.loadTotalView, required this.loadMyComment, required this.loadListComments});
  final String filmID;
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Flexible(child: Divider(height: 20.h)),
            Row(
              children: [
                Expanded(
                    child: TextFormField(
